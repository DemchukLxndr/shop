...
export const STATUS_DATA_CORRUPTED = "DATA_CORRUPTED";
export const STATUS_FAILED_TO_FETCH_CATEGORIES = "FAILED_TO_FETCH_CATEGORIES";
export const STATUS_FAILED_TO_FETCH_CURRENCIES = "FAILED_TO_FETCH_CURRENCIES";
export const STATUS_FAILED_TO_FETCH_PRODUCTS = "FAILED_TO_FETCH_PRODUCTS";
export const STATUS_FAILED_TO_FETCH_PRODUCT = "FAILED_TO_FETCH_PRODUCT";
